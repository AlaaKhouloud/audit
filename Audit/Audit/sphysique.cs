...
namespace Audit
{
    public partial class sphysique : Form
    {
        public sphysique()
        {
            InitializeComponent();
        ...
        private void sphysique_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select title , subtitle , question , commentaire , coeficient , jugement , etat_traitement from Audit_questions where title = 'Sécurité physique'"; ;
