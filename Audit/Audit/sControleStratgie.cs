...
namespace Audit
{
    public partial class sControleStratgie : Form
    {
        ...
        private void sControleStratgie_Load(object sender, EventArgs e)
        {
            ...
            string sql = "select title , subtitle , question , commentaire , coeficient , jugement , etat_traitement from Audit_questions where title = 'Stratégie et controle interne'"; ;
